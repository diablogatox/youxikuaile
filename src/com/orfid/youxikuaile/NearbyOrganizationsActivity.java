...
public class NearbyOrganizationsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        nearbyOrganizationsLv.setAdapter(new MyAdapter());
	}
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(NearbyOrganizationsActivity.this).inflate(
